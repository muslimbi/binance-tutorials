...
candlesticks = client.get_historical_klines("BTCUSDT", Client.KLINE_INTERVAL_15MINUTE, "1 Jan, 2021", "06 Mar, 2021")
candlesticks = client.get_historical_klines("XVSUSDT", Client.KLINE_INTERVAL_15MINUTE, "1 Jan, 2021", "06 Mar, 2021")
